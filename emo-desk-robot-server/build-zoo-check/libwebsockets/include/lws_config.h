...
#define LWS_INSTALL_DATADIR "C:/Program Files (x86)/emo-desk-robot-server/share"
#define LWS_INSTALL_LIBDIR "C:/Program Files (x86)/emo-desk-robot-server/lib"
#define LWS_PLUGIN_DIR "C:/Program Files (x86)/emo-desk-robot-server/share/libwebsockets-test-server/plugins"
#define LWS_LIBRARY_VERSION_MAJOR 4
#define LWS_LIBRARY_VERSION_MINOR 5
#define LWS_LIBRARY_VERSION_PATCH_ELABORATED 99-v4.5.0-559-g7316933ae
...
#define LWS_BUILD_HASH "v4.5.0-559-g7316933ae"
...
#define LWS_LIBRARY_VERSION "4.5.99-v4.5.0-559-g7316933ae"
